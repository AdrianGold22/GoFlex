	...
	<div class="container" style=" width: 100%;">
		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				<!-- MOVIES GENRE WISE-->
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="" style="color: #0080ff; font-weight: bold;">
			...
			<form class="navbar-form navbar-right" method="post" action="<?php echo base_url(); ?>index.php?browse/search">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="Titulo, gente, generos" style="background-color: #000; border: 1px solid #808080;" name="search_key">
				</div>
